// <copyright file="PaymentsApi.cs" company="APIMatic">
...
namespace PaypalServerSdk.Standard.Apis
{
    ...
    /// PaymentsApi.
    /// </summary>
    public class PaymentsApi : BaseApi
    {
        /// <summary>
            ...
            => await CreateApiCall<Models.PaymentAuthorization>()
              .RequestBuilder(requestBuilder => requestBuilder
                  ...
                  .Parameters(parameters => parameters
                      .Template(template => template.Setup("authorization_id", input.AuthorizationId).Required())
        ...
        public async Task<ApiResponse<Models.CapturedPayment>> GetCapturedPaymentAsync(
            ...
            => await CreateApiCall<Models.CapturedPayment>()
              .RequestBuilder(requestBuilder => requestBuilder
                  ...
                  .WithAuth("Oauth2")
                  .Parameters(parameters => parameters
                      .Template(template => template.Setup("capture_id", input.CaptureId).Required())
                      .Header(header => header.Setup("PayPal-Mock-Response", input.PaypalMockResponse))))
              .ResponseHandler(responseHandler => responseHandler
                  .ErrorCase("401", CreateErrorCase("Authentication failed due to missing authorization header, or invalid authentication credentials.", (errorReason, context) => new ErrorException(errorReason, context)))
                  .ErrorCase("403", CreateErrorCase("The request failed because the caller has insufficient permissions.", (errorReason, context) => new ErrorException(errorReason, context)))
        ...
        public async Task<ApiResponse<Models.Refund>> GetRefundAsync(
            ...
            => await CreateApiCall<Models.Refund>()
              .RequestBuilder(requestBuilder => requestBuilder
                  ...
                  .WithAuth("Oauth2")
                  .Parameters(parameters => parameters
                      .Template(template => template.Setup("refund_id", input.RefundId).Required())
                      .Header(header => header.Setup("PayPal-Mock-Response", input.PaypalMockResponse))
                      .Header(header => header.Setup("PayPal-Auth-Assertion", input.PaypalAuthAssertion))))
              .ResponseHandler(responseHandler => responseHandler
                  .ErrorCase("401", CreateErrorCase("Authentication failed due to missing authorization header, or invalid authentication credentials.", (errorReason, context) => new ErrorException(errorReason, context)))

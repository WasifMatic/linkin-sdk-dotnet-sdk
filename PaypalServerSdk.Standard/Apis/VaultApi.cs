// <copyright file="VaultApi.cs" company="APIMatic">
...
namespace PaypalServerSdk.Standard.Apis
{
    ...
    public class VaultApi : BaseApi
    {
        ...
        /// </summary>
        internal VaultApi(GlobalConfiguration globalConfiguration) : base(globalConfiguration) { }
            ...
            => await CreateApiCall<Models.PaymentTokenResponse>()
              .RequestBuilder(requestBuilder => requestBuilder
                  ...
                  .Parameters(parameters => parameters
                      .Body(b => b.Setup(input.Body).Required())
        ...
        public async Task<ApiResponse<Models.CustomerVaultPaymentTokensResponse>> ListCustomerPaymentTokensAsync(
            ...
            => await CreateApiCall<Models.CustomerVaultPaymentTokensResponse>()
              .RequestBuilder(requestBuilder => requestBuilder
                  ...
                  .WithAuth("Oauth2")
                  .Parameters(parameters => parameters
                      .Query(query => query.Setup("customer_id", input.CustomerId).Required())
